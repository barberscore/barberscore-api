...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contestant.is_complete'
        db.add_column(u'bbs_contestant', 'is_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contestant.is_complete'
        db.delete_column(u'bbs_contestant', 'is_complete')
