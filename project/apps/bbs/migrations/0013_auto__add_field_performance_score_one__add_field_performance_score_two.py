...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.score_one'
        db.add_column(u'bbs_performance', 'score_one',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Performance.score_two'
        db.add_column(u'bbs_performance', 'score_two',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Performance.score_one'
        db.delete_column(u'bbs_performance', 'score_one')

        # Deleting field 'Performance.score_two'
        db.delete_column(u'bbs_performance', 'score_two')
