...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.stage_time'
        db.add_column(u'bbs_performance', 'stage_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Performance.stage_time'
        db.delete_column(u'bbs_performance', 'stage_time')
    ...
    models = {
        ...
        u'bbs.performance': {
            ...
            'stage_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        u'bbs.rating': {
