...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contestant.website'
        db.add_column(u'bbs_contestant', 'website',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Contestant.facebook'
        db.add_column(u'bbs_contestant', 'facebook',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contestant.website'
        db.delete_column(u'bbs_contestant', 'website')

        # Deleting field 'Contestant.facebook'
        db.delete_column(u'bbs_contestant', 'facebook')
