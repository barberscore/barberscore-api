...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Performance.prelim'
        db.alter_column(u'bbs_performance', 'prelim', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Performance.prelim'
        db.alter_column(u'bbs_performance', 'prelim', self.gf('django.db.models.fields.IntegerField')(null=True))
