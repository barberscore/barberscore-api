...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Performance.contest_round'
        db.alter_column(u'bbs_performance', 'contest_round', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

    def backwards(self, orm):

        # Changing field 'Performance.contest_round'
        db.alter_column(u'bbs_performance', 'contest_round', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
