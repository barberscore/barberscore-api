...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Performance.song_two'
        db.delete_column(u'bbs_performance', 'song_two_id')

        # Deleting field 'Performance.song_one'
        db.delete_column(u'bbs_performance', 'song_one_id')


    def backwards(self, orm):
        # Adding field 'Performance.song_two'
        db.add_column(u'bbs_performance', 'song_two',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='song_two', null=True, to=orm['bbs.Song'], blank=True),
                      keep_default=False)

        # Adding field 'Performance.song_one'
        db.add_column(u'bbs_performance', 'song_one',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='song_one', null=True, to=orm['bbs.Song'], blank=True),
                      keep_default=False)
