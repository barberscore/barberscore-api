...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contest.convention_id'
        db.add_column(u'bbs_contest', 'convention_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bbs.Convention']),
                      keep_default=False)
    ...
    models = {
        ...
        u'bbs.contest': {
            ...
            'convention_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bbs.Convention']"}),
