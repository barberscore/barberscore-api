...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Convention.contest_type'
        db.add_column(u'bbs_convention', 'contest_type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Convention.contest_type'
        db.delete_column(u'bbs_convention', 'contest_type')
