...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rating.song_one'
        db.alter_column(u'bbs_rating', 'song_one', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Rating.song_two'
        db.alter_column(u'bbs_rating', 'song_two', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Rating.song_one'
        db.alter_column(u'bbs_rating', 'song_one', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Rating.song_two'
        db.alter_column(u'bbs_rating', 'song_two', self.gf('django.db.models.fields.FloatField')(null=True))
