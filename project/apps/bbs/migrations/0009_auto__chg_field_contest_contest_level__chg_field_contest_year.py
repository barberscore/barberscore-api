...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contest.contest_level'
        db.alter_column(u'bbs_contest', 'contest_level', self.gf('django.db.models.fields.CharField')(default=1, max_length=20))

        # Changing field 'Contest.year'
        db.alter_column(u'bbs_contest', 'year', self.gf('django.db.models.fields.CharField')(default=2013, max_length=4))

    def backwards(self, orm):

        # Changing field 'Contest.contest_level'
        db.alter_column(u'bbs_contest', 'contest_level', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Contest.year'
        db.alter_column(u'bbs_contest', 'year', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))
