...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contest.contest_type'
        db.alter_column(u'bbs_contest', 'contest_type', self.gf('django.db.models.fields.CharField')(default='Quartet', max_length=20))

        # Changing field 'Contest.panel_size'
        db.alter_column(u'bbs_contest', 'panel_size', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Contest.time_zone'
        db.alter_column(u'bbs_contest', 'time_zone', self.gf('timezone_field.fields.TimeZoneField')())

    def backwards(self, orm):

        # Changing field 'Contest.contest_type'
        db.alter_column(u'bbs_contest', 'contest_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Contest.panel_size'
        db.alter_column(u'bbs_contest', 'panel_size', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Contest.time_zone'
        db.alter_column(u'bbs_contest', 'time_zone', self.gf('timezone_field.fields.TimeZoneField')(null=True))
