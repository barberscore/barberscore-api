...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contest.name'
        db.alter_column(u'bbs_contest', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Contest.name'
        db.alter_column(u'bbs_contest', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
