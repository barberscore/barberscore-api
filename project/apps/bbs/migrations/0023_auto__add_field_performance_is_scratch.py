...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.is_scratch'
        db.add_column(u'bbs_performance', 'is_scratch',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Performance.is_scratch'
        db.delete_column(u'bbs_performance', 'is_scratch')
