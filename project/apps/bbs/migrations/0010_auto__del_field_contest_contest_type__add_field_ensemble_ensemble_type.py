...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contest.contest_type'
        db.delete_column(u'bbs_contest', 'contest_type')

        # Adding field 'Contestant.contestant_type'
        db.add_column(u'bbs_contestant', 'contestant_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Contest.contest_type'
        db.add_column(u'bbs_contest', 'contest_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Contestant.contestant_type'
        db.delete_column(u'bbs_contestant', 'contestant_type')
