...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.place'
        db.add_column(u'bbs_performance', 'place',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Performance.seed'
        db.add_column(u'bbs_performance', 'seed',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Performance.prelim'
        db.add_column(u'bbs_performance', 'prelim',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Performance.place'
        db.delete_column(u'bbs_performance', 'place')

        # Deleting field 'Performance.seed'
        db.delete_column(u'bbs_performance', 'seed')

        # Deleting field 'Performance.prelim'
        db.delete_column(u'bbs_performance', 'prelim')
