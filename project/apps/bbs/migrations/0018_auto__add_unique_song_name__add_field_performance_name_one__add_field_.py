...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Song', fields ['name']
        db.create_unique(u'bbs_song', ['name'])

        # Adding field 'Performance.name_one'
        db.add_column(u'bbs_performance', 'name_one',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Performance.name_two'
        db.add_column(u'bbs_performance', 'name_two',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Song', fields ['name']
        db.delete_unique(u'bbs_song', ['name'])

        # Deleting field 'Performance.name_one'
        db.delete_column(u'bbs_performance', 'name_one')

        # Deleting field 'Performance.name_two'
        db.delete_column(u'bbs_performance', 'name_two')
    ...
    models = {
        ...
        u'bbs.performance': {
            ...
            'avg_score': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
