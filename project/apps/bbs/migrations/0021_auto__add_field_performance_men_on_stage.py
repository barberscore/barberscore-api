...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.men_on_stage'
        db.add_column(u'bbs_performance', 'men_on_stage',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Performance.men_on_stage'
        db.delete_column(u'bbs_performance', 'men_on_stage')
