...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bbs_contest', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=200))

        # Changing field 'Score.slug'
        db.alter_column(u'bbs_score', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=200))

        # Changing field 'Contestant.slug'
        db.alter_column(u'bbs_contestant', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=200))

    def backwards(self, orm):

        # Changing field 'Contest.slug'
        db.alter_column(u'bbs_contest', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'Score.slug'
        db.alter_column(u'bbs_score', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'Contestant.slug'
        db.alter_column(u'bbs_contestant', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
