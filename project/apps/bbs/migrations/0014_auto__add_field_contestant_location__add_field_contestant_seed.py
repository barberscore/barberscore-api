...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contestant.location'
        db.add_column(u'bbs_contestant', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Contestant.seed'
        db.add_column(u'bbs_contestant', 'seed',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contestant.location'
        db.delete_column(u'bbs_contestant', 'location')

        # Deleting field 'Contestant.seed'
        db.delete_column(u'bbs_contestant', 'seed')
