...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'rate_userprofile')


    def backwards(self, orm):
        # Adding model 'UserProfile'
        db.create_table(u'rate_userprofile', (
            ...
            ('prediction', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'rate', ['UserProfile'])
