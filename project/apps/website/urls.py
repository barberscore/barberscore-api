...
urlpatterns = [
    ...
    # url(r'^choruses/performances/$', views.ChorusPerformanceList.as_view(), name='chorus-performance-list'),
    # url(r'^choruses/performances/(?P<slug>[a-zA-Z0-9-]+)/$', views.ChorusPerformanceDetail.as_view(), name='chorus-performance-detail'),
