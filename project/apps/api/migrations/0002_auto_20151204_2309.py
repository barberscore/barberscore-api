...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='contest',
            name='organization',
            field=mptt.fields.TreeForeignKey(related_name='contests', blank=True, to='api.Organization', help_text=b'\n            The organization that will confer the award.  Note that this may be different than the organization running the parent contest.', null=True),
        ),
        migrations.AddField(
            model_name='contest',
            name='year',
        ...
        migrations.AlterField(
            model_name='contest',
            name='kind',
            field=models.IntegerField(help_text=b'\n            The kind of contest.  Generally this will be either quartet or chorus, with the exception being International and Midwinter which hold exclusive Collegiate and Senior contests respectively.', choices=[(1, b'Quartet'), (2, b'Chorus'), (3, b'Senior'), (4, b'Collegiate')]),
        ),
        migrations.AlterField(
            model_name='contest',
            name='rounds',
            field=models.IntegerField(help_text=b'\n            Number of rounds (sessions) for the contest.', choices=[(3, 3), (2, 2), (1, 1)]),
        ),
        migrations.AlterField(
            model_name='contest',
            name='size',
        ...
        migrations.AlterField(
            model_name='convention',
            name='status',
            field=models.IntegerField(default=0, choices=[(0, b'New'), (10, b'Built'), (20, b'Started'), (30, b'Final')]),
        ),
    ]
