...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0042_auto_20151217_1006'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='contest',
            options={'ordering': ('session', 'award', 'goal')},
        ),
        migrations.AddField(
            model_name='contest',
            name='award',
            field=models.ForeignKey(related_name='contests', blank=True, to='api.Award', null=True),
        ),
        ...
        migrations.AlterField(
            model_name='contest',
            name='kind',
            field=models.IntegerField(blank=True, help_text=b'\n            The kind of the contest.  Note that this may be different than the kind of the parent session.', null=True, choices=[(1, b'Quartet'), (2, b'Chorus'), (3, b'Senior'), (4, b'Collegiate'), (5, b'Novice'), (6, b'Plateau A'), (7, b'Plateau AA'), (8, b'Plateau AAA')]),
        ),
        migrations.AlterField(
            model_name='contest',
            name='level',
        ...
        migrations.AlterField(
            model_name='contest',
            name='organization',
            field=mptt.fields.TreeForeignKey(related_name='contests', blank=True, to='api.Organization', help_text=b'\n            The organization that will confer the contest.  Note that this may be different than the organization running the parent session.', null=True),
        ),
        migrations.AlterField(
            model_name='contest',
            name='rounds',
        ...
        migrations.AlterUniqueTogether(
            name='contest',
            unique_together=set([('session', 'award', 'goal')]),
        ),
