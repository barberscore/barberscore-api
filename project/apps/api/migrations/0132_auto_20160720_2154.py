# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-21 04:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='status',
            field=django_fsm.FSMIntegerField(choices=[(0, b'New'), (90, b'Published')], default=0),
        ),
        migrations.AddField(
            model_name='performance',
            name='performancescore',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.PerformanceScore'),
        ),
    ]
