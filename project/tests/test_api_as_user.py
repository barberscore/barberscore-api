...
def test_organization_endpoint_list(user_api_client, organization):
...
def test_participant_endpoint_list(user_api_client, participant):
...
def test_organization_endpoint_detail(user_api_client, organization):
...
def test_participant_endpoint_detail(user_api_client, participant):
