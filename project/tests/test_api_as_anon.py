...
def test_organization_endpoint_list(anon_api_client, organization):
...
def test_participant_endpoint_list(anon_api_client, participant):
...
def test_organization_endpoint_detail(anon_api_client, organization):
...
def test_participant_endpoint_detail(anon_api_client, participant):
